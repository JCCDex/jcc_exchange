...
describe("test jc exchange", () => {
  ...
  describe("test createOrder", () => {
    ...
    it("create order successfully", async () => {
      ...
      mock.onGet(/^\/exchange\/sequence\//).reply(
        200,
        {
          code: "0",
          data: {
      ...
      mock.onPost("/exchange/sign_order").reply(
        200,
        {
          code: "0",
          data: {
    ...
    it("create order failed: terPRE_SEQ", async () => {
      ...
      try {
        ...
        expect(spy1.secondCall.args[0]).to.equal(
          ""
        );
      }
    });
  ...
  describe("test cancelOrder", () => {
    ...
    it("cancel order successfully", async () => {
      ...
      mock.onDelete("/exchange/sign_cancel_order").reply(
        200,
        {
          code: "0",
          data: {
  ...
  describe("test transferAccount", () => {
    ...
    it("transfer account successfully", async () => {
      ...
      mock.onPost("/exchange/sign_payment").reply(
        200,
        {
          code: "0",
          data: {
  ...
  describe("test setBrokerage", () => {
    ...
    it("transfer account successfully", async () => {
      ...
      mock.onPost("/exchange/brokerage").reply(
        200,
        {
          code: "0",
          data: {
