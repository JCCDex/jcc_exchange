  ...
  describe('test createOrder', function() {
    ...
    it('create order successfully', function(done) {
      ...
      JCCExchange.createOrder(testAddress, testSecret, "1", "jjcc", "cny", "1", "buy").then(hash => {
        ...
        expect(spy1.calledOnceWith("")).to.true;
        sandbox.restore();
        done()
      })
    })
